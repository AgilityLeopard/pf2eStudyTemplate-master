export default {
  data() {
    return {
      ...
      weaponGroup: [
        {
          group: "axe",
          name: "Топор",
          crit: "Выберите 1 существо рядом с изначальной целью и находящееся в пределах досягаемости. Если его КБ ниже результата вашего броска атаки от критического попадания, то вы наносите этому существу урон, равный результату совершенного броска костей урона этого оружия (включая дополнительные кости от руны мощи (см. Руна мощи оружия / Руна 2+), если она есть). Значение этого урона не удваивается, и к нему не добавляются никакие бонусы или дополнительные кости."
        },
        {
          group: "bomb",
          name: "Бомба",
        ...
        },
        {
          group: "brawling",
          name: "Драка",
          crit: "Цель должна совершить успешный спасбросок Стойкости с вашим КС класса, иначе получит состояние замедлен 1 до конца вашего следующего хода."
        },
        {
          group: "club",
          name: "Дубинка",
          crit: "Вы отталкиваете от себя цель на расстояние вплоть до 10 футов (вы выбираете расстояние). Это Принудительное передвижение (Forced Movement).",
        },
        {
          group: "dart",
          name: "Дротик",
          crit: "Цель получает 1d6 продолжительного урона кровотечением. Вы получаете к этому урону кровотечением бонус предмета, равный бонусу предмета оружия к броскам атак.",
        },
        {
          group: "flail",
          name: "Цеп",
          crit: "Цель падает на землю ничком.",
        },
        {
          group: "hammer",
          name: "Молот",
        ...
        },
        {
          group: "pick",
          name: "Клевец",
          crit: "Оружие жестоко пронзает цель, и она получает 2 дополнительного урона за каждую кость урона оружия.",
        },

        {
          group: "polearm",
          name: "Древковое",
          crit: "Цель двигается на 5 футов в направлении по вашему выбору. Это Принудительное передвижение (Forced Movement).",
        },
        {
          group: "shield",
          name: "Щит",
          crit: "Вы отталкиваете цель от себя на 5 футов. Это Принудительное передвижение (Forced Movement).",
        },
        {
          group: "sling",
          name: "Праща",
          crit: "Цель должна совершить успешный спасбросок Стойкости с вашим КС класса, иначе получит состояние ошеломлен 1.",
        },
        {
          group: "spear",
          name: "Копье",
          crit: "Это оружие прокалывает цель, ослабляя ее атаки. Цель получает состояние неуклюжесть 1 до начала вашего следующего хода.",
        },
        {
          group: "sword",
          name: "Меч",
      ...
      WornGear: {
        "wornamulet": "Амулет",
        "wornandattachedtotwoweapons": "Носимый и прикрепленный к двум оружиям",
        "wornanklets": "Лодыжки",
        "wornarmbands": "Нарукавники",
        "wornbackpack": "Рюкзак",
        "wornbarding": "Броня животного",
        "wornbelt": "Пояс",
        "wornbeltpouch": "Поясная сумка",
        "wornboots": "Носимые ботинки",
        "wornbracelet": "Браслет",
        "wornbracers": "Браслеты",
        "worncap": "Носимая шапка",
        "worncape": "Носимый плащ",
        "worncirclet": "Диадема",
        "worncloak": "Накидка",
        "wornclothing": "Одежда",
        "worncollar": "Ошейник",
        "worncrown": "Корона",
        "wornepaulet": "Эполеты",
        "worneyeglasses": "Носимые очки",
        "worneyepiece": "Окуляр",
        "wornfootwear": "Носимая обувь",
        "worngarment": "Одежда",
        "worngloves": "Перчатки",
        "wornheadwear": "Головной убор",
        "wornhorseshoes": "Подковы",
        "wornmask": "Маска",
        "wornnecklace": "Ожерелье",
        "wornonbelt": "Поясной предмет",
        "wornonwrists": "Запястья",
        "wornoronehand": "Носить или держать в одной руке",
        "wornring": "Кольцо",
        "wornsaddle": "Седло",
