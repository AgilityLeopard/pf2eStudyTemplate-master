...
export default {
  ...
  head() {
    const itemSchemaArray = this.vaultItems.map((item) => {
      return {
        ...
        thumbnailUrl: item.image
          ? `http://www.shadow-of-tales.ru${item.image.fields.file.url}`
          : null,
    ...
    const image = "http://www.shadow-of-tales.ru/img/artwork_vault_bright.jpg";
      ...
      faqItems: [
        {
          ...
          a:
            ...
            'the <a href="http://www.shadow-of-tales.ru/vault/agents-of-the-golden-throne">Agents of the Golden Throne</a> supplement ' +
        ...
        },
        {
          ...
          a:
            ...
            'Most notably are the <a href="http://www.shadow-of-tales.ru/vault/the-deathwatch---slayers-of-the-alien-horde">Slayers of the Alien Horde</a> ' +
            'and <a href="http://www.shadow-of-tales.ru/vault/the-emperors-angels">The Emperor’s Angels</a>.',
        },
      ],
    };
  },
