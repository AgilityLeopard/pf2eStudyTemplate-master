...
export default {
  ...
  head() {
    const itemSchemaArray = this.vaultItems.map((item) => {
      return {
        ...
        thumbnailUrl: item.image
          ? `https://pf2e-ru-builder.netlify.app${item.image.fields.file.url}`
          : null,
    ...
    const image =
      "https://pf2e-ru-builder.netlify.app/img/artwork_vault_bright.jpg";
      ...
      faqItems: [
        {
          ...
          a:
            ...
            'the <a href="https://pf2e-ru-builder.netlify.app/vault/agents-of-the-golden-throne">Agents of the Golden Throne</a> supplement ' +
        ...
        },
        {
          ...
          a:
            ...
            'Most notably are the <a href="https://pf2e-ru-builder.netlify.app/vault/the-deathwatch---slayers-of-the-alien-horde">Slayers of the Alien Horde</a> ' +
            'and <a href="https://pf2e-ru-builder.netlify.app/vault/the-emperors-angels">The Emperor’s Angels</a>.',
        },
      ],
    };
  },
      ...
      if (navigator.share) {
        navigator
          .share({
            ...
            url: `https://www.shadow-of-tales/vault/${item.urlSlug}`,
          })
