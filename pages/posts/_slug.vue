        ...
        <ColorfulEntry :headline="post.fields.title" flavour="blog">
          <v-row>
            <v-col :cols="12" :md="10">
              ...
              <contentful-html-text
                :html="toHtml(post.fields.content)"
              ></contentful-html-text>
            </v-col>
          </v-row>
        </ColorfulEntry>
...
export default {
  ...
  head() {
    ...
    const image = this.post.fields.imageTwitter
      ...
      : `https://pf2e-ru-builder.netlify.app/img/artwork_posts.jpg`;
  ...
  computed: {
    breadcrumbItems() {
      return [
        ...
        {
          text: this.post.fields.shortTitle,
          disabled: false,
          nuxt: true,
          exact: true,
          to: `/posts/${this.post.fields.slug}`,
        },
      ];
    },
  },
