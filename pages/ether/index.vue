  ...
  head() {
    const itemSchemaArray = this.actualPlayItems
      ...
      return {
        ...
        thumbnailUrl: item.image ? `https://pf2e-ru-builder.netlify.app${item.image.fields.file.url}` : null,
    ...
    const description = '';
    const image = 'https://pf2e-ru-builder.netlify.app/img/artwork_ether.jpg';
