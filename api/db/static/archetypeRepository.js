...
const playerCore =  [
  ...
  // },
  // {
  //   ...archetype(source.playerCore.key, 110,'Adeptus Ministorum','Crusader',3,'Human'),
  //   ...cost(54,20,34, 0, 0),
  ...
  // // Adepta Sororitas
  // {
  //   ...archetype(source.playerCore.key, 91,'Adepta Sororitas','Sister Hospitaller',1,'Human'),
  //   ...cost(24,0,24,0,0),
  ...
  // },
  // {
  //   ...archetype(source.playerCore.key, 99,'Adepta Sororitas','Sister of Battle',2,'Human'),
  //   ...cost(64,10,54, 0, 0),
  ...
  // // Adeptus Militarum
  // {
  //   ...archetype(source.playerCore.key, 93,'Astra Militarum','Imperial Guardsman',1,'Human'),
  //   ...cost(6,0,6, 0, 0),
  ...
  // },
  // {
  //   ...archetype(source.playerCore.key, 103,'Astra Militarum','Tempestus Scion',2,'Human'),
  //   ...cost(52,10,42, 0, 0),
  ...
  // },
  // {
  //   ...archetype(source.playerCore.key, 111,'Astra Militarum','Imperial Commissar',3,'Human'),
  //   ...costz(76,[
  //     reqAttribute(ATTRIBUTES.STRENGTH, 3),
  //     reqAttribute(ATTRIBUTES.TOUGHNESS, 3),
  ...
  // // Inquisition
  // {
  //   ...archetype(source.playerCore.key, 94,'The Inquisition','Inquisitorial Acolyte',1,'Human'),
  //   ...cost(6,0,6, 0, 0),
  ...
  // },
  // {
  //   ...archetype(source.playerCore.key, 95,'The Inquisition','Inquisitorial Sage',1,'Human'),
  //   ...cost(16,0,16, 0, 0),
  ...
  // },
  // {
  //   ...archetype(source.playerCore.key, 104,'Rogue Trader Dynasties','Rogue Trader',2,'Human'),
  //   ...cost(36,10,26,0,0),
  ...
  // },
  // {
  //   ...archetype(source.playerCore.key, 100,'Adeptus Astra Telephatica','Sanctioned Psyker',2,'Human'),
  //   ...cost(32, 10, 22, 0, 0),
  ...
  // },
  // {
  //   ...archetype(source.playerCore.key, 116,'The Inquisition','Inquisitor',4,'Human'),
  //   ...cost(110,30,80, 0, 0),
  ...
  // },
  // {
  //   ...archetype(source.playerCore.key, 106,'Adeptus Astartes','Space Marine Scout',2,'Adeptus Astartes'),
  //   ...cost(170,10,160, 0, 0),
  ...
  // },
  // {
  //   ...archetype(source.playerCore.key, 113,'Adeptus Astartes','Tactical Space Marine',3,'Adeptus Astartes'),
  //   ...costz(257,[
  ...
  // },
  // {
  //   ...archetype(source.playerCore.key, 117,'Adeptus Astartes','Primaris Intercessor',4,'Primaris Astartes'),
  //   ...costz(300, [
  ...
  // // Adeptus Mechanicus
  // {
  //   ...archetype(source.playerCore.key, 101,'Adeptus Mechanicus','Skitarius',2,'Human'),
  //   ...cost(28,10,18, 0, 0),
  ...
  // },
  // {
  //   ...archetype(source.playerCore.key, 109,'Adeptus Mechanicus','Tech-Priest',3,'Human'),
  //   ...costz(44,[
  //     reqAttribute(ATTRIBUTES.INTELLECT, 3),
  //     reqSkill(SKILLS.SCHOLAR, 1),
  ...
  // // Scum
  // {
  //   ...archetype(source.playerCore.key, 96,'Scum','Ganger',1,'Human'),
  //   ...cost(2,0,2, 0, 0),
  ...
  // },
  // {
  //   ...archetype(source.playerCore.key, 105,'Scum','Scavvy',2,'Human'),
  //   ...cost(16,10,6, 0, 0),
  ...
  // },
  // {
  //   ...archetype(source.playerCore.key, 112,'Scum','Desperado',3,'Human'),
  //   ...cost(52,20,32, 0, 0),
  ...
  // // Renegades
  // {
  //   ...archetype(source.playerCore.key, 96,'Chaos','Cultist',1,'Human'),
  //   ...cost(2,0,2, 0, 0),
  ...
  // },
  // {
  //   ...archetype(source.playerCore.key, 100,'Chaos','Rogue Psyker',2,'Human'),
  //   ...cost(32,10,22, 0, 0),
  //   hint: 'How could you...',
  ...
  // },
  // {
  //   ...archetype(source.playerCore.key, 109,'Chaos','Heretek',3,'Human'),
  //   ...costz(44,[
  //     reqAttribute(ATTRIBUTES.INTELLECT, 3),
  //     reqSkill(SKILLS.SCHOLAR, 1),
  //     reqSkill(SKILLS.TECH, 3),
  ...
  // },
  // {
  //   ...archetype(source.playerCore.key, 113,'Chaos','Chaos Space Marine',3,'Adeptus Astartes'),
  //   ...costz(257,[
  ...
  // // Aeldari
  // {
  //   ...archetype(source.playerCore.key, 97,'Aeldari','Corsair',1,'Aeldari'),
  //   ...cost(16,0,16, 0, 0),
  ...
  // },
  // {
  //   ...archetype(source.playerCore.key, 107,'Aeldari','Ranger',2,'Aeldari'),
  //   ...cost(34,10,24, 0, 0),
  ...
  // },
  // {
  //   ...archetype(source.playerCore.key, 114,'Aeldari','Warlock',3,'Aeldari'),
  //   ...cost(56,20,36, 0, 0),
  ...
  // // Orks
  // {
  //   ...archetype(source.playerCore.key, 98,'Orks','Boy',1,'Ork'),
  //   ...cost(26,0,26, 0, 0),
  ...
  // },
  // {
  //   ...archetype(source.playerCore.key, 108,'Orks','Kommando',2,'Ork'),
  //   ...cost(54,10,44, 0, 0),
  ...
  // },
  // {
  //   ...archetype(source.playerCore.key, 115,'Orks','Ork Nob',3,'Ork'),
  //   key: 'playerCore-nob',
  //   ...cost(56,20,36, 0, 0),
...
//       attributes: [],
//       skills: [],
//       talents: [ 'playerCore-augmetic', 'playerCore-binary-chatter', 'playerCore-deductive' ],
//     },
//     suggestedStats: [
...
//       attributes: [],
//       skills: [],
//       talents: [ 'playerCore-deadshot', 'playerCore-eliminator', 'playerCore-silent' ],
//     },
//     suggestedStats: [
...
//       attributes: [],
//       skills: [],
//       talents: [ 'playerCore-augmetic', 'playerCore-brutalist', 'playerCore-duty-until-death' ],
//     },
//     suggestedStats: [
...
//       attributes: [],
//       skills: [],
//       talents: [ 'playerCore-brutalist', 'playerCore-die-hard', 'playerCore-fear' ],
//     },
//     suggestedStats: [
...
//         modifications: [
//           { targetGroup: 'talents', targetValue: 'playerCore-bolstering-purity', meta: { name: 'Bolstering Purity' } },
//           { targetGroup: 'talents', targetValue: 'playerCore-consecrated-light', meta: { name: 'Consecrated Light' } },
//         ],
//       },
//     ],
...
//         modifications: [
//           { targetGroup: 'talents', targetValue: 'playerCore-deadshot', meta: { name: 'Deadshot' } },
//         ],
//       },
//       {
//         name: 'Skirmisher',
...
//   archetype(source.amb.key, 6, 'Astra Militarum', 'Bulwark',  2, 'playerCoreab/Ogryn', true),
