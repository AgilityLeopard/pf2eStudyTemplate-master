...
const playerCore = [
  ...
  {
    ...talent('playerCore', 130, 'Harden Flesh'),
    type: "class",
    traits: 'земля, друид',
    ...
    level: 10,
    prerequisites: "орден Камня (Stone)",
    requirementsText: "Вы стоите на земле из почвы или камня",
  ...
  {
    ...talent('playerCore', 130, 'Eerie Proclamation'),
    type: "class",
