...
// const playerCore =  [
//   {
//     ...talent('playerCore',129,'Acute Sense [Sense]',20,'Skill'),
//     key: 'playerCore-acute-sense',
...
//     options: [
//       { key: stringToKebab('playerCore acute sense sight'), name: 'Sight' },
//       { key: stringToKebab('playerCore acute sense hearing'), name: 'Hearing' },
//       { key: stringToKebab('playerCore acute sense smell'), name: 'Smell' },
//       { key: stringToKebab('playerCore acute sense taste'), name: 'Taste' },
//       { key: stringToKebab('playerCore acute sense touch'), name: 'Touch' },
//     ],
...
//   },
//   {
//     ...talent('playerCore',129,'Angel Of Death',30,'Combat,Damage'),
...
//   },
//   {
//     ...talent('playerCore',129,'Armourbane',20,'Combat,Melee,Damage'),
...
//   },
//   /*{
//     ...talent('playerCore',129,'Augmetic, Very Rare',20,'Wargear'),
...
//   {
//     ...talent('playerCore',129,'Augmetic, One Very Rare',20,'Wargear'),
//     key: 'playerCore-augmetic-very-rare',
...
//   },
//   {
//     ...talent('playerCore',129,'Augmetic, Two Rare',20,'Wargear'),
//     key: 'playerCore-augmetic-rare',
...
//   },
//   {
//     ...talent('playerCore',130,'Betrayer',20,'Corruption'),
...
//   },
//   {
//     ...talent('playerCore',130,'Berzerker',20,'Corruption,Wrath'),
...
//   {
//     ...talent('playerCore',130,'Blindfighter',20,'Melee,Combat'),
...
//   },
//   {
//     ...talent('playerCore',130,'Blood Must Flow!',20,'Melee,Combat,Debuff'),
...
//   },
//   {
//     ...talent('playerCore',130,'Bombardment',40,'Ranged,Combat,Damage,Area'),
...
//   },
//   {
//     ...talent('playerCore',130,'Brutalist',20,'Combat,Damage'),
...
//   },
//   {
//     ...talent('playerCore',130,'Chaos Familiar',20,'Corruption,Utility,Survival'),
...
//   },
//   {
//     ...talent('playerCore',131,'Conversational Cogitator',10,'Interaction'),
...
//   },
//   {
//     ...talent('playerCore',131,'Counter Attack',30,'Combat,Melee'),
...
//   },
//   {
//     ...talent('playerCore',131,'Deadshot',20,'Combat,Ranged,Damage'),
...
//   },
//   {
//     ...talent('playerCore',132,'Death or Glory!',20,'Melee,Morale'),
...
//   },
//   {
//     ...talent('playerCore',132,'Deductive',20,'Utility'),
...
//   },
//   {
//     ...talent('playerCore',132,'Devotees',30,'Utility,Survival'),
...
//   },
//   {
//     ...talent('playerCore',132,'Die Hard',20,'Survival'),
...
//   },
//   {
//     ...talent('playerCore',132,'Dirty Fighter',20,'Combat,Interaction,Debuff'),
...
//   },
//   {
//     ...talent('playerCore',132,'Discipline Savant',30,'Warp'),
...
//   },
//   {
//     ...talent('playerCore',133,'Disturbing Voice',20,'Social'),
...
//   },
//   {
//     ...talent('playerCore',133,'Dual Wield',20,'Combat,Ranged,Melee'),
...
//   },
//   {
//     ...talent('playerCore',133,'Duty Until Death',20,'Combat'),
...
//   },
//   {
//     ...talent('playerCore',133,'Eliminator',20,'Combat,Stealth'),
...
//   },
//   {
//     ...talent('playerCore',133,'Escape Artist',20,'Utility'),
...
//   },
//   {
//     ...talent('playerCore',133,'Ever Vigilant',20,'Utility'),
...
//   },
//   {
//     ...talent('playerCore',133,'Favoured By The Warp',40,'Warp,Survival'),
...
//   },
//   {
//     ...talent('playerCore',133,'Fear',30,'Intimidation'),
...
//   },
//   {
//     ...talent('playerCore',133,'Fearless',30,'Surviuval'),
...
//   },
//   {
//     ...talent('playerCore',134,'Feel no Pain',40,'Survival,Combat'),
...
//   },
//   {
//     ...talent('playerCore',134,'Flagellant',20,'Combat,Melee'),
...
//   },
//   {
//     ...talent('playerCore',134,'Frenzy',20,'Combat,Melee'),
...
//   },
//   {
//     ...talent('playerCore',134,'Furious Charge',20,'Combat,Melee'),
...
//   },
//   {
//     ...talent('playerCore',134,'Gallows Humour',20,'Support,Survival'),
...
//   },
//   {
//     ...talent('playerCore',134,'Hardy',30,'Survival'),
...
//   },
//   {
//     ...talent('playerCore',135,'Hatred [Any]',30,'Combat,Melee,Social'),
//     key: 'playerCore-hatred',
...
//   },
//   {
//     ...talent('playerCore',135,'Hive Explorer',20),
...
//   },
//   {
//     ...talent('playerCore',135,'Jargon [Skill]',20),
//     key: 'playerCore-jargon',
...
//   },
//   {
//     ...talent('playerCore',135,'Legacy Of Sorrow',20),
...
//   },
//   {
//     ...talent('playerCore',136,'Let The Galaxy Burn',20),
...
//   },
//   {
//     ...talent('playerCore',136,'Lip Reader',20),
...
//   },
//   {
//     ...talent('playerCore',136,'Lobotomised Efficiency',20),
...
//   },
//   {
//     ...talent('playerCore',136,'Loremaster [Keyword]',30),
//     key: 'playerCore-loremaster',
...
//   },
//   {
//     ...talent('playerCore',136,'Mark Of Chaos',30),
...
//   },
//   {
//     ...talent('playerCore',136,'Mark Of Nurgle',30),
...
//   },
//   {
//     ...talent('playerCore',136,'Mark Of Khorne',30),
...
//   },
//   {
//     ...talent('playerCore',136,'Mark Of Slaanesh',30),
...
//   },
//   { // Duplicate
//     ...talent('playerCore',136,'Mark Of Tzeentch',30),
...
//   },
//   {
//     ...talent('playerCore',136,'Mark Of Undedicated',30),
...
//   },
//   {
//     ...talent('playerCore',136,'Mastered Paths',20),
...
//   },
//   {
//     ...talent('playerCore',137,'Mimic Voice',20),
...
//   },
//   {
//     ...talent('playerCore',137,'Mob Rule',20),
...
//   },
//   {
//     ...talent('playerCore',137,'More Dakka!',35),
...
//   },
//   {
//     ...talent('playerCore',137,'Noble Peer',30),
...
//   },
//   {
//     ...talent('playerCore',137,'Orthopraxy',20),
...
//   },
//   {
//     ...talent('playerCore',137,'Paranoid',20),
...
//   },
//   {
//     ...talent('playerCore',137,'Primaris Perspective',40),
...
//   },
//   {
//     ...talent('playerCore',138,'Promethium Proficiency',20),
...
//   },
//   {
//     ...talent('playerCore',138,'Rite Of Fear',30),
...
//   },
//   {
//     ...talent('playerCore',138,'Rite Of Magnometrics',20),
...
//   },
//   {
//     ...talent('playerCore',139,'Rite Of Pure Thought',20),
...
//   },
//   {
//     ...talent('playerCore',139,'Scum Savvy',20),
...
//   },
//   {
//     ...talent('playerCore',139,'Secret Identity',20),
...
//   },
//   {
//     ...talent('playerCore',139,'Sidestep',30),
...
//   },
//   {
//     ...talent('playerCore',139,'Silent',20),
...
//   },
//   {
//     ...talent('playerCore',139,'Simultaneous Strike (Ballistic Skill)',30),
//     snippet: 'You add half your second weapons damage as ED to the damage roll.',
//     description: '<p></p>',
//     requirements: [ requireSkill('ballisticSkill',4) ],
//   },
//   {
//     ...talent('playerCore',139,'Simultaneous Strike (Weapon Skill)',30),
//     snippet: 'You add half your second weapons damage as ED to the damage roll.',
//     description: '<p></p>',
//     requirements: [ requireSkill('weaponSkill',4) ],
//   },
//   {
//     ...talent('playerCore',139,'Smash Attack',20),
...
//   },
//   {
//     ...talent('playerCore',140,'Special Weapons Trooper',20), // + weapon
...
//   },
//   {
//     ...talent('playerCore',140,'Stoic',20),
...
//   },
//   {
//     ...talent('playerCore',140,'Storm of Death',30),
...
//   },
//   {
//     ...talent('playerCore',140,'Supplicant',20),
...
//   },
//   {
//     ...talent('playerCore',140,'Supreme Presence [Skill]',30),
//     key: 'playerCore-supreme-presence',
...
//   },
//   {
//     ...talent('playerCore',140,'Tenacious',30),
...
//   },
//   {
//     ...talent('playerCore',140,'The Flesh Is Weak',30),
...
//   },
//   {
//     ...talent('playerCore',141,'Touched By Fate',20),
...
//   },
//   {
//     ...talent('playerCore',141,'Trademark Weapon [Weapon]',30),
//     key: 'playerCore-trademark-weapon',
...
//   },
//   {
//     ...talent('playerCore',141,'Transhuman [Attribute]',60),
//     key: 'playerCore-transhuman-attribute',
...
//   },
//   {
//     ...talent('playerCore',141,'Twin Focus',20),
...
//   },
//   {
//     ...talent('playerCore',141,'Uncanny [Trait]',40),
//     key: 'playerCore-uncanny-trait',
...
//   },
//   {
//     ...talent('playerCore',141,'Unnatural [Skill]',60),
//     key: 'playerCore-unnatural-skill',
...
//   },
//   {
//     ...talent('playerCore',141,'Unremarkable',20),
...
//   },
//   {
//     ...talent('playerCore',141,'Warped Mind [Discipline]',30),
...
//   // FAITH
//   {
//     ...talent('playerCore',142,'Bolstering Purity',40, 'Faith'),
//     group: 'Faith',
//     groupKey: 'playerCore-faith',
//     modifications: [
...
//   },
//   {
//     ...talent('playerCore',143,'By His Will',20,'Faith'),
//     group: 'Faith',
//     groupKey: 'playerCore-faith',
//     modifications: [
//       { targetGroup: 'resources', targetValue: 'faith', modifier: 1 },
...
//   },
//   {
//     ...talent('playerCore',143,'Consecrated Light',20,'Faith'),
//     group: 'Faith',
//     groupKey: 'playerCore-faith',
//     modifications: [
//       { targetGroup: 'resources', targetValue: 'faith', modifier: 1 },
...
//   },
//   {
//     ...talent('playerCore',143,'Divine Guidance',20,'Faith'),
//     group: 'Faith',
//     groupKey: 'playerCore-faith',
//     modifications: [
//       { targetGroup: 'resources', targetValue: 'faith', modifier: 1 },
...
//   },
//   {
//     ...talent('playerCore',143,'In His Name',20,'Faith'),
//     group: 'Faith',
//     groupKey: 'playerCore-faith',
//     modifications: [
//       { targetGroup: 'resources', targetValue: 'faith', modifier: 1 },
...
//   },
//   {
//     ...talent('playerCore',143,'Inspired Blessing',25,'Faith'),
//     group: 'Faith',
//     groupKey: 'playerCore-faith',
//     modifications: [
//       { targetGroup: 'resources', targetValue: 'faith', modifier: 1 },
...
//   },
//   {
//     ...talent('playerCore',143,'Litany Of Hatred',20,'Faith'),
//     group: 'Faith',
//     groupKey: 'playerCore-faith',
//     modifications: [
//       { targetGroup: 'resources', targetValue: 'faith', modifier: 1 },
...
//   },
//   {
//     ...talent('playerCore',143,'Martyr’s Tears',20,'Faith'),
//     group: 'Faith',
//     groupKey: 'playerCore-faith',
//     modifications: [
//       { targetGroup: 'resources', targetValue: 'faith', modifier: 1 },
...
//   },
//   {
//     ...talent('playerCore',144,'Repent!',20,'Faith'),
//     group: 'Faith',
//     groupKey: 'playerCore-faith',
//     modifications: [
//       { targetGroup: 'resources', targetValue: 'faith', modifier: 1 },
...
//   },
//   {
//     ...talent('playerCore',144,'Righteous Wrath',20,'Faith'),
//     group: 'Faith',
//     groupKey: 'playerCore-faith',
//     modifications: [
//       { targetGroup: 'resources', targetValue: 'faith', modifier: 1 },
...
//   },
//   {
//     ...talent('playerCore',144,'Shield Of Faith',20,'Faith'),
//     group: 'Faith',
//     groupKey: 'playerCore-faith',
//     modifications: [
//       { targetGroup: 'resources', targetValue: 'faith', modifier: 1 },
...
//   },
//   {
//     ...talent('playerCore',144,'The Passion',20,'Faith'),
//     group: 'Faith',
//     groupKey: 'playerCore-faith',
//     modifications: [
//       { targetGroup: 'resources', targetValue: 'faith', modifier: 1 },
...
//   },
//   {
//     ...talent('playerCore',144,'The Emperor Protects',30,'Faith'),
//     group: 'Faith',
//     groupKey: 'playerCore-faith',
//     modifications: [
//       { targetGroup: 'resources', targetValue: 'faith', modifier: 1 },
