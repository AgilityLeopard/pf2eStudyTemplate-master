...
const playerCore = [
...

    {
        ...
        traits: ["расходуемый", "electricity", "магический", "зелье"],
        category: "зелье",
        rarity: "common",
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Полученное из энергии опасных заклинаний, <em>зелье энергетического дыхания</em> наделяет вас действием "Энергетическое дыхание" на 1 час после того, как вы его выпьете.</p><p><strong>Энергетическое дыхание:</strong><span class="action-glyph">1</span> Вы создаёте 30-футовую линию электричества, которая наносит 10d6 electricity урона. Каждое существо в области должно совершить простой спасбросок Рефлекса.</p><p>После использования "Энергетического дыхания", вы не можете снова использовать его 1d4 раунда.</p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Полученное из энергии опасных заклинаний, <em>зелье энергетического дыхания</em> наделяет вас действием "Энергетическое дыхание" на 1 час после того, как вы его выпьете.</p><p><strong>Энергетическое дыхание:</strong><span class="action-glyph">1</span> Вы создаёте 30-футовую линию электричества, которая наносит 6d6 electricity урона. Каждое существо в области должно совершить простой спасбросок Рефлекса.</p><p>После использования "Энергетического дыхания", вы не можете снова использовать его 1d4 раунда.</p>`
    },
...

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Полученное из энергии опасных заклинаний, <em>зелье энергетического дыхания</em> наделяет вас действием "Энергетическое дыхание" на 1 час после того, как вы его выпьете.</p><p><strong>Энергетическое дыхание:</strong><span class="action-glyph">1</span> Вы создаёте 30-футовую линию электричества, которая наносит 4d6 electricity урона. Каждое существо в области должно совершить простой спасбросок Рефлекса.</p><p>После использования "Энергетического дыхания", вы не можете снова использовать его 1d4 раунда.</p>`
    },
...

    {
        ...
        traits: ["расходуемый", "магический", "талисман"],
        category: "other",
        rarity: "uncommon",
        weight: 0.1,
        usage: "affixed-to-a-metal-weapon",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (концентрация)</p><hr /><p>Несмотря на твёрдость, эта металлическая сфера переливается яркими серебристыми и темными железными цветами, словно жидкая. При активации <em>легирующей сферы</em>, выберите адамантин, холодное железо или рассветное серебро. Присоединённое оружие функционирует как выбранный материал в течение 1 минуты, подавляя свой первоначальный материал. Эта сфера действует на оружие любого уровня.</p><p></p>`
    },

    {
        ...
        traits: ["acid", "расходуемый", "магический", "зелье"],
        category: "зелье",
        rarity: "common",
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Полученное из энергии опасных заклинаний, <em>зелье энергетического дыхания</em> наделяет вас действием "Энергетическое дыхание" на 1 час после того, как вы его выпьете.</p><p><strong>Энергетическое дыхание:</strong><span class="action-glyph">1</span> Вы создаёте 30-футовую линию кислоты, которая наносит 10d6 acid урона. Каждое существо в области должно совершить простой спасбросок Рефлекса.</p><p>После использования "Энергетического дыхания", вы не можете снова использовать его 1d4 раунда.</p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Полученное из энергии опасных заклинаний, <em>зелье энергетического дыхания</em> наделяет вас действием "Энергетическое дыхание" на 1 час после того, как вы его выпьете.</p><p><strong>Энергетическое дыхание:</strong><span class="action-glyph">1</span> Вы создаёте 30-футовую линию кислоты, которая наносит 6d6 acid урона. Каждое существо в области должно совершить простой спасбросок Рефлекса.</p><p>После использования "Энергетического дыхания", вы не можете снова использовать его 1d4 раунда.</p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Полученное из энергии опасных заклинаний, <em>зелье энергетического дыхания</em> наделяет вас действием "Энергетическое дыхание" на 1 час после того, как вы его выпьете.</p><p><strong>Энергетическое дыхание:</strong><span class="action-glyph">1</span> Вы создаёте 30-футовую линию кислоты, которая наносит 4d6 acid урона. Каждое существо в области должно совершить простой спасбросок Рефлекса.</p><p>После использования "Энергетического дыхания", вы не можете снова использовать его 1d4 раунда.</p>`
    },

    {
        ...
        traits: ["холод", "расходуемый", "магический", "зелье"],
        category: "зелье",
        rarity: "common",
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Полученное из энергии опасных заклинаний, <em>зелье энергетического дыхания</em> наделяет вас действием "Энергетическое дыхание" на 1 час после того, как вы его выпьете.</p><p><strong>Энергетическое дыхание:</strong><span class="action-glyph">1</span> Вы создаёте 15-футовый конус холода, который наносит 10d6 cold урона. Каждое существо в области должно совершить простой спасбросок Рефлекса.</p><p>После использования "Энергетического дыхания", вы не можете снова использовать его 1d4 раунда.</p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Полученное из энергии опасных заклинаний, <em>зелье энергетического дыхания</em> наделяет вас действием "Энергетическое дыхание" на 1 час после того, как вы его выпьете.</p><p><strong>Энергетическое дыхание:</strong><span class="action-glyph">1</span> Вы создаёте 15-футовый конус холода, который наносит 6d6 cold урона. Каждое существо в области должно совершить простой спасбросок Рефлекса.</p><p>После использования "Энергетического дыхания", вы не можете снова использовать его 1d4 раунда.</p>`
    },

    {
        ...
        traits: ["расходуемый", "огонь", "магический", "зелье"],
        category: "зелье",
        rarity: "common",
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Полученное из энергии опасных заклинаний, <em>зелье энергетического дыхания</em> наделяет вас действием "Энергетическое дыхание" на 1 час после того, как вы его выпьете.</p><p><strong>Энергетическое дыхание:</strong><span class="action-glyph">1</span> Вы создаёте 15-футовый конус огня, который наносит 10d6 fire урона. Каждое существо в области должно совершить простой спасбросок Рефлекса.</p><p>После использования "Энергетического дыхания", вы не можете снова использовать его 1d4 раунда.</p>`
    },
...

    {
        ...
        traits: ["расходуемый", "магический", "зелье", "звуковой"],
        category: "зелье",
        rarity: "common",
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Полученное из энергии опасных заклинаний, <em>зелье энергетического дыхания</em> наделяет вас действием "Энергетическое дыхание" на 1 час после того, как вы его выпьете.</p><p><strong>Энергетическое дыхание:</strong><span class="action-glyph">1</span> Вы создаёте 15-футовый конус звука, который наносит 10d6 sonic урона. Каждое существо в области должно совершить простой спасбросок Стойкости.</p><p>После использования "Энергетического дыхания", вы не можете снова использовать его 1d4 раунда.</p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Полученное из энергии опасных заклинаний, <em>зелье энергетического дыхания</em> наделяет вас действием "Энергетическое дыхание" на 1 час после того, как вы его выпьете.</p><p><strong>Энергетическое дыхание:</strong><span class="action-glyph">1</span> Вы создаёте 15-футовый конус звука, который наносит 6d6 sonic урона. Каждое существо в области должно совершить простой спасбросок Стойкости.</p><p>После использования "Энергетического дыхания", вы не можете снова использовать его 1d4 раунда.</p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Полученное из энергии опасных заклинаний, <em>зелье энергетического дыхания</em> наделяет вас действием "Энергетическое дыхание" на 1 час после того, как вы его выпьете.</p><p><strong>Энергетическое дыхание:</strong><span class="action-glyph">1</span> Вы создаёте 15-футовый конус холода, который наносит 4d6 cold урона. Каждое существо в области должно совершить простой спасбросок Рефлекса.</p><p>После использования "Энергетического дыхания", вы не можете снова использовать его 1d4 раунда.</p>`
    },
...

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Полученное из энергии опасных заклинаний, <em>зелье энергетического дыхания</em> наделяет вас действием "Энергетическое дыхание" на 1 час после того, как вы его выпьете.</p><p><strong>Энергетическое дыхание:</strong><span class="action-glyph">1</span> Вы создаёте 15-футовый конус звука, который наносит 4d6 sonic урона. Каждое существо в области должно совершить простой спасбросок Стойкости.</p><p>После использования "Энергетического дыхания", вы не можете снова использовать его 1d4 раунда.</p>`
    },

    {
        ...
        traits: ["расходуемый", "магический", "зелье"],
        category: "зелье",
        rarity: "common",
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Выпивание этого густого укрепляющего зелья даёт на 1 час сопротивление 15 к электричеству.</p><p></p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Выпивание этого густого укрепляющего зелья даёт на 1 час сопротивление 10 к электричеству.</p><p></p>`
    },

    {
        ...
        weight: 0.1,
        usage: "affixed-to-a-metal-weapon",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (концентрация)</p><hr /><p>Несмотря на твёрдость, эта металлическая сфера переливается яркими серебристыми и темными железными цветами, словно жидкая. При активации <em>легирующей сферы</em>, выберите адамантин, холодное железо или рассветное серебро. Присоединённое оружие функционирует как выбранный материал в течение 1 минуты, подавляя свой первоначальный материал. Эта сфера действует на оружие 15-го уровня или ниже.</p><p></p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Выпивание этого густого укрепляющего зелья даёт на 1 час сопротивление 5 к электричеству.</p><p></p>`
    },
...

    {
        ...
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (концентрация)</p><p><strong>Требования:</strong> Вы обучены Атлетике</p><hr /><p>Эта мерцающая зеленая чешуйка обычно крепится к золотой застёжке или цепочке.</p><p>Когда вы активируете чешуйку, то на 1 минуту получаете Скорость плавания равную вашей наземной Скорости.</p><p></p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Выпивание этого густого укрепляющего зелья даёт на 1 час сопротивление 15 к кислоте.</p><p></p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Выпивание этого густого укрепляющего зелья даёт на 1 час сопротивление 10 к кислоте.</p><p></p>`
    },
...

    {
        ...
        traits: ["инвестируемый", "магический"],
        category: "misc",
        rarity: "uncommon",
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p>Этот сверкающий кулон изготовлен из драгоценного камня со свинцовыми вкраплениями. Заклинатели могут сотворять заклинания в <em>кулоны противодействия</em>, которые инвестировали они готовое существо. Эффект заклинания не происходит, вместо этого сила заклинания сохраняется в кулоне, заменяя находящееся там до этого заклинание. Кулон может хранить только заклинания, сотворенные из слотов заклинания, а не чары и не заклинания фокусировки. Когда кулон инвестирован, инвестировавшее его существо знает, какое заклинание в нем заключено и автоматически его определяет при его сотворении.</p><hr /><p><strong>Активация—Противодействовать:</strong><span class="action-glyph">R</span> (воздействие)</p><p><strong>Триггер:</strong> Вы являетесь целью или находитесь в области действия заклинания, заключённого в кулоне</p><p><strong>Требования:</strong> У вас есть свободная рука</p><p><strong>Эффект:</strong> Вы демонстрируете кулон и пытаетесь противодействовать спровоцировавшему заклинанию, используя ранг заклинания из кулона и модификатор противодействия +30. Это расходует хранящееся в кулоне заклинание.</p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Выпивание этого густого укрепляющего зелья даёт на 1 час сопротивление 15 к холоду.</p><p></p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Выпивание этого густого укрепляющего зелья даёт на 1 час сопротивление 10 к холоду.</p><p></p>`
    },
...

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Выпивание этого густого укрепляющего зелья даёт на 1 час сопротивление 5 к кислоте.</p><p></p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Выпивание этого густого укрепляющего зелья даёт на 1 час сопротивление 15 к звуку.</p><p></p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Выпивание этого густого укрепляющего зелья даёт на 1 час сопротивление 10 к звуку.</p><p></p>`
    },

    {
        ...
        weight: 0.1,
        usage: "wornbracers",
        description: `<p>Эти наручи сделаны из пластин прочного рассветного серебра и блестят, как летнее солнце.</p><hr /><p><strong>Активация:</strong><span class="action-glyph">R</span> (воздействие)</p><p><strong>Частота:</strong> Раз в 10 минут</p><p><strong>Триггер:</strong> Атака дистанционным оружием попадает по вам, но не критически</p><p><strong>Требования:</strong> Вы знаете об атаке и не застигнуты врасплох</p><p><strong>Эффект:</strong> Браслеты уводят стрелу с ее курса. Вы получаете бонус обстоятельства +2 к КБ против спровоцировавшей атаки. Если из-за этого результат атаки будет неудачным, то она промахивается по вам.</p><p></p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Выпивание этого густого укрепляющего зелья даёт на 1 час сопротивление 5 к холоду.</p><p></p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Выпивание этого густого укрепляющего зелья даёт на 1 час сопротивление 15 к огню.</p><p></p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Выпивание этого густого укрепляющего зелья даёт на 1 час сопротивление 5 к звуку.</p><p></p>`
    },
...

    {
        ...
        description: `<p><strong>Активация:</strong><span class="action-glyph">F</span> (концентрация)</p><p><strong>Триггер:</strong> Вы попали по Застигнутому врасплох существу с помощью прикрепленного оружия</p><hr /><p>Этот длинный полый хоботок собирают с небезызвестного зверя кровоискателя, и с него капает тонкая струйка крови.</p><p>Когда вы активируете хоботок, вы наносите дополнительные 2d4 точного урона при броске на урон. Если вы наносите урон от Внезапной атаки, то существо так же получает 2d4 урона кровотечением.</p><p></p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p>Этот сверкающий кулон изготовлен из драгоценного камня со свинцовыми вкраплениями. Заклинатели могут сотворять заклинания в <em>кулоны противодействия</em>, которые инвестировали они готовое существо. Эффект заклинания не происходит, вместо этого сила заклинания сохраняется в кулоне, заменяя находящееся там до этого заклинание. Кулон может хранить только заклинания, сотворенные из слотов заклинания, а не чары и не заклинания фокусировки. Когда кулон инвестирован, инвестировавшее его существо знает, какое заклинание в нем заключено и автоматически его определяет при его сотворении.</p><hr /><p><strong>Активация—Противодействовать:</strong><span class="action-glyph">R</span> (воздействие)</p><p><strong>Триггер:</strong> Вы являетесь целью или находитесь в области действия заклинания, заключённого в кулоне</p><p><strong>Требования:</strong> У вас есть свободная рука</p><p><strong>Эффект:</strong> Вы демонстрируете кулон и пытаетесь противодействовать спровоцировавшему заклинанию, используя ранг заклинания из кулона и модификатор противодействия +25. Это расходует хранящееся в кулоне заклинание.</p>`
    },

    {
        ...
        traits: ["алхимический", "расходуемый", "эликсир"],
        category: "эликсир",
        rarity: "common",
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>После того, как вы выпьете этот эликсир, ваше зрение в темноте становится острее. Вы получаете ночное зрение на 24 часа.</p><p></p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>После того, как вы выпьете этот эликсир, ваше зрение в темноте становится острее. Вы получаете ночное зрение на 1 час.</p><p></p>`
    },
...

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Выпив этот эликсир, вы замечаете тонкие визуальные детали. В течение следующего часа вы получаете бонус предмета +3 к проверкам Восприятия или +4 при попытке поиска скрытых дверей и ловушек.</p><p></p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Выпив этот эликсир, вы замечаете тонкие визуальные детали. В течение следующего часа вы получаете бонус предмета +3 к проверкам Восприятия или +4 при попытке поиска скрытых дверей и ловушек.</p><p>Каждый раз, когда вы проходите в 10 футах от скрытой двери или ловушки, Мастер автоматически бросает за вас тайную проверку поиска.</p><p></p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Выпив этот эликсир, вы замечаете тонкие визуальные детали. В течение следующего часа вы получаете бонус предмета +2 к проверкам Восприятия или +3 при попытке поиска скрытых дверей и ловушек.</p><p></p>`
    },

    {
        ...
        traits: ["огонь", "магический"],
        category: "misc",
        rarity: "common",
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p>Напоминающее <em>застывшую лаву</em>, <em>вечное извержение</em> создано с помощью того же типа магии времени, но построено таким образом, чтобы зацикливаться во времени, реформируя себя после использования. Чтобы определить разницу между ними, нужно внимательно присмотреться и увидеть слабый, повторяющийся узор из красных рун.</p><hr /><p><strong>Активация—Лавовая бомба:</strong><span class="action-glyph">2</span> (воздействие, концентрация)</p><p><strong>Эффект:</strong> Вы бросаете <em>вечное извержение</em> с эффектом Застывшей лавы Утёса Дроскара. После 2d4 часов, <em>вечное извержение</em> восстанавливается в носимом вами контейнере, обычно в том, в котором вы хранили его последний раз.</p><p><em>Вечное извержение Утёса Дроскара</em> наносит 13d6 fire урона с простым спасброском Рефлекса.</p>`
    },

    {
        ...
        traits: ["расходуемый", "огонь", "магический"],
        category: "ammo",
        rarity: "common",
        weight: 0,
        usage: "held-in-one-hand",
        description: `<p><strong>Амуниция:</strong> любая</p><p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Эта амуниция покрыта чёрной сажей. Когда активированная <em>отличная взрывающаяся амуниция</em> попадает в цель, то взрывается 10-футовым взрывом, нанося 10d6 fire урона каждому существу в области (включая цель). Каждое существо должно совершить простой спасбросок Рефлекса.</p>`
    },

    {
        ...
        traits: ["алхимический", "расходуемый", "эликсир", "иллюзия", "визуальный"],
        category: "эликсир",
        rarity: "common",
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Слабый туман исходит от вашей кожи, давая вам в течение указанного времени состояние Скрытый на 5 минут.</p><p>Как обычно, будучи скрытым когда ваша позиция всё ещё очевидна, вы не можете использовать его, чтобы Спрятаться или Красться.</p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Слабый туман исходит от вашей кожи, давая вам в течение указанного времени состояние Скрытый на 1 минуту.</p><p>Как обычно, будучи скрытым когда ваша позиция всё ещё очевидна, вы не можете использовать его, чтобы Спрятаться или Красться.</p>`
    },
...

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Выпивание этого густого укрепляющего зелья даёт на 1 час сопротивление 5 к огню.</p><p></p>`
    },

    {
        ...
        traits: ["межпространственный", "инвестируемый", "магический"],
        category: "misc",
        rarity: "uncommon",
        weight: 0,
        usage: "wornbelt",
        description: `<p>Этот пояс покрыт маленькими подсумками, которые застёгиваются на пуговицы из тщательно вырезанного камня. Пояс привязан к межпространственному карману, в котором может храниться до десяти предметов Массой 1 или менее. Любой, кто держит пояс, может ощущать его содержимое, но хранить или извлекать предметы могут только те, кто инвестировал пояс. Во многих случаях пояс находят с уже находящимся в нем предметом.</p><hr /><p><strong>Активация—Убрать предмет:</strong><span class="action-glyph">1</span> (воздействие)</p><p><strong>Требования:</strong> В ремне есть место для предмета</p><p><strong>Эффект:</strong> Один предмет, который вы держите, Массой 1 или менее исчезает в межпространственном кармане ремня.</p><hr /><p><strong>Активация—Достать предмет:</strong><span class="action-glyph">F</span> (воздействие)</p><p><strong>Требования:</strong> В ремне хранится предмет и у вас есть свободная рука</p><p><strong>Эффект:</strong> Хранящийся в ремне предмет появляется в вашей руке. Активации "Убрать предмет" и "Достать предмет" нельзя использовать в течение 1 минуты.</p>`
    },

    {
        ...
        weight: 1,
        usage: "held-in-one-hand",
        description: `<p>Это медное кадило, которое болтается на длинной цепочке. Большинство <em>курильниц откровения</em> украшены кружащимся Эмпирейскими текстами, хотя некоторые из них сделаны из железа и содержат Дьявольские или Хтонические тексты.</p><hr /><p><strong>Активация—Сжечь благовония:</strong><span class="action-glyph">2</span> (воздействие)</p><p><strong>Стоимость:</strong> благовония стоимостью хотя бы 5 зм</p><p><strong>Эффект:</strong> Вы зажигаете благовония внутри кадила и они горят 1 час. В течение этого времени, пока вы держите курильницу, вы получаете бонус предмета +3 к проверкам Религии и любые критические провалы при Расшифровке текста религиозной природы становятся просто провалами.</p><p>Раз в день, когда вы активируете курильницу, то можете увеличить её откровения. Во время активации, с помощью действия Взаимодействовать вы можете держать курильницу на уровне глаз, чтобы, смотря через дым, получить эффекты @UUID[Compendium.pf2e.spells-srd.Item.jwK43yKsHTkJQvQ9] и @UUID[Compendium.pf2e.spells-srd.Item.uqlxMQQeSGWEVjki] на 1 раунд.</p><p></p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Эта настойка позволяет вам точно заострить внимание на своих врагов. На следующие 5 минут, ваши Удары алхимическими бомбами снижают бонус обстоятельства к КБ, получаемый врагами от укрытия на 2.</p><p></p>`
    },
...

    {
        ...
        traits: ["магический", "видение"],
        category: "misc",
        rarity: "uncommon",
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p>Эта полированная хрустальная сфера усиливает магию видения. Любая визуальная информация, полученная через заклинание с признаком видение, которое было сотворено <em>хрустальным шаром</em>, появляется внутри сферы, а любая слуховая информация звучит с поверхности сферы. Когда вы, держа сферу, "Сотворяете заклинание" с признаком видение любым другим способом, то можете таким же образом перенаправить любую получаемую информацию, позволяя другим видеть или слышать цель.</p><hr /><p><strong>Активация—Ясновидение:</strong> 1 минута (воздействие, концентрация)</p><p><strong>Частота:</strong> Раз в час</p><p><strong>Эффект:</strong><em>Хрустальный шар</em> сотворяет @UUID[Compendium.pf2e.spells-srd.Item.zvKWclOZ7A53DObE] с вашими требованиями.</p><hr /><p><strong>Активация—Видение:</strong> 10 минут (воздействие, концентрация)</p><p><strong>Частота:</strong> Дважды в день</p><p><strong>Эффект:</strong><em>Хрустальный шар</em> сотворяет @UUID[Compendium.pf2e.spells-srd.Item.r784cIz17eWujtQj] @Check[will|dc:37|name:Видение] с вашими требованиями, и даёт вам преимущества Чтения разума на цель, с тем же КС спасброска.</p>`
    },

    {
        ...
        traits: ["сакральный", "инвестируемый"],
        category: "misc",
        rarity: "uncommon",
        weight: 0,
        usage: "worn",
        description: `<p>Это потускневшее ожерелье может быть инвестировано только святыми или нечестивыми. Когда вы инвестируете его, оно превращается в религиозный символ вашего божества или в личный символ, если у вас нет божества. Вы получаете бонус предмета +3 к Религии и бонус обстоятельства +1 к спасброскам от святых и нечестивых эффектов.</p><hr /><p><strong>Активация—Присутствие:</strong><span class="action-glyph">2</span> (воздействие, концентрация)</p><p><strong>Частота:</strong> Раз в день</p><p><strong>Эффект:</strong> Символ сотворяет @UUID[Compendium.pf2e.spells-srd.Item.7ZinJNzxq0XF0oMx] @UUID[Compendium.pf2e.spells-srd.Item.XSujb7EsSwKl19Uu], @UUID[Compendium.pf2e.spells-srd.Item.hVU9msO9yGkxKZ3J] или @UUID[Compendium.pf2e.spells-srd.Item.SUKaxVZW2TlM8lu0] 6-го ранга. Добавьте @UUID[Compendium.pf2e.spells-srd.Item.lTDixrrNKaCvLKwX] 6-го ранга, если вы святой, или @UUID[Compendium.pf2e.spells-srd.Item.29ytKctjg7qSW2ff], если вы нечестивый.</p><p>КС противодействия этим эффектам 38, модификатор противодействия +28.</p><hr /><p><strong>Требования для создания:</strong> Вы должны быть святым или нечестивым.</p>`
    },

    {
        ...
        weight: 1,
        usage: "held-in-one-hand",
        description: `<p>Это медное кадило, которое болтается на длинной цепочке. Большинство <em>курильниц откровения</em> украшены кружащимся Эмпирейскими текстами, хотя некоторые из них сделаны из железа и содержат Дьявольские или Хтонические тексты.</p><hr /><p><strong>Активация—Сжечь благовония:</strong><span class="action-glyph">2</span> (воздействие)</p><p><strong>Стоимость:</strong> благовония стоимостью хотя бы 5 зм</p><p><strong>Эффект:</strong> Вы зажигаете благовония внутри кадила и они горят 1 час. В течение этого времени, пока вы держите курильницу, вы получаете бонус предмета +2 к проверкам Религии и любые критические провалы при Расшифровке текста религиозной природы становятся просто провалами.</p><p>Раз в день, когда вы активируете курильницу, то можете увеличить её откровения. Во время активации, с помощью действия Взаимодействовать вы можете держать курильницу на уровне глаз, чтобы, смотря через дым, получить эффекты @UUID[Compendium.pf2e.spells-srd.Item.jwK43yKsHTkJQvQ9] на 1 раунд.</p><p></p>`
    },

    {
        ...
        weight: 0,
        usage: "worn",
        description: `<p>Это элегантное медное кольцо имеет миниатюрные изображения певчих птиц, выгравированные по его окружности. Вы получаете бонус предмета +2 к проверкам Обмана.</p><hr /><p><strong>Активация—Чревовещать:</strong><span class="action-glyph">2</span> (воздействие)</p><p><strong>Частота:</strong> Сколько угодно раз в день</p><p><strong>Эффект:</strong> Вращение кольца вокруг пальца позволяет вам магически передавать ваш голос с эффектами заклинания @UUID[Compendium.pf2e.spells-srd.Item.yV7Ouzaoe7DHLESI] 2-го ранга (@Check[perception|dc:27]).</p>`
    },

    {
        ...gear(source.GMCore.key, 1065, 'Волшебная палочка бури осколков [1-го ранга] / волшебная палочка of Shardstorm (1st-Rank Spell)', '160G', ''),
        ...price(0, 160, 0, 0),
        nameGear: "Волшебная палочка бури осколков [1-го ранга] / волшебная палочка of Shardstorm (1st-Rank Spell)",
        traits: ["сила", "магический", "волшебная палочка"],
        category: "misc",
        rarity: "common",
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p>Эта палочка имеет резную голову дракона на вершине и полированную металлическую сферу посередине.</p><hr /><p><strong>Активация:</strong> Сотворение заклинания</p><p><strong>Частота:</strong> Раз в день, плюс перегрузка</p><p><strong>Эффект:</strong> Вы сотворяете @UUID[Compendium.pf2e.spells-srd.Item.gKKqvLohtrSJj3BM] 1-го ранга.</p><p>После сотворения заклинания, в начале каждого вашего хода из палочки выпускается дополнительный осколок или осколки, как если бы вы сотворяли версию <em>шквала силы</em> в 1 действие. Каждый раз выбирайте цели. Это длится в течение 1 минуты, пока вы больше не владеете палочкой или пока снова не попытаетесь активировать палочку.</p><p><strong>Требования для создания:</strong> Сотворение заклинания <em>шквала силы</em> соответствующего ранга.</p>`
    },

    {
        ...gear(source.GMCore.key, 1066, 'Волшебная палочка бури осколков [3-го ранга] / волшебная палочка of Shardstorm (3rd-Rank Spell)', '700G', ''),
        ...price(0, 700, 0, 0),
        nameGear: "Волшебная палочка бури осколков [3-го ранга] / волшебная палочка of Shardstorm (3rd-Rank Spell)",
        traits: ["сила", "магический", "волшебная палочка"],
        category: "misc",
        rarity: "common",
        weight: 0.1,
    ...
    {
        ...gear(source.GMCore.key, 1067, 'Волшебная палочка бури осколков [5-го ранга] / волшебная палочка of Shardstorm (5th-Rank Spell)', '3000G', ''),
        ...price(0, 3000, 0, 0),
        nameGear: "Волшебная палочка бури осколков [5-го ранга] / волшебная палочка of Shardstorm (5th-Rank Spell)",
        traits: ["сила", "магический", "волшебная палочка"],
        category: "misc",
        rarity: "common",
        weight: 0.1,
    ...
    {
        ...gear(source.GMCore.key, 1068, 'Волшебная палочка бури осколков [7-го ранга] / волшебная палочка of Shardstorm (7th-Rank Spell)', '15000G', ''),
        ...price(0, 15000, 0, 0),
        nameGear: "Волшебная палочка бури осколков [7-го ранга] / волшебная палочка of Shardstorm (7th-Rank Spell)",
        traits: ["сила", "магический", "волшебная палочка"],
        category: "misc",
        rarity: "common",
        weight: 0.1,
...

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>После того, как вы выпьете этот эликсир, ваше зрение в темноте становится острее. Вы получаете ночное зрение на 10 минут.</p><p></p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Выпив этот эликсир, вы замечаете тонкие визуальные детали. В течение следующего часа вы получаете бонус предмета +1 к проверкам Восприятия или +2 при попытке поиска скрытых дверей и ловушек.</p><p></p>`
    },

    {
        ...
        weight: 0,
        usage: "affixed-to-armor",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (концентрация)</p><p><strong>Требования:</strong> Вы обучены Атлетике</p><hr /><p>Этот металлический кузнечик, усыпанный изумрудами, обычно крепится к защите ног доспеха.</p><p>После его активации, сделайте Прыжок на расстояние вплоть до 100 футов горизонтально и до 30 футов вертикально. Это преимущество применяется для всех других "Прыжков", которые вы делаете до конца своего хода. Если вы заканчиваете свой прыжок не на твердой поверхности, то будете порхать в воздухе до конца своего хода, а потом невредимо падаете со скоростью 60 футов в раунд, пока не достигните земли.</p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p>Напоминающее <em>застывшую лаву</em>, <em>вечное извержение</em> создано с помощью того же типа магии времени, но построено таким образом, чтобы зацикливаться во времени, реформируя себя после использования. Чтобы определить разницу между ними, нужно внимательно присмотреться и увидеть слабый, повторяющийся узор из красных рун.</p><hr /><p><strong>Активация—Лавовая бомба:</strong><span class="action-glyph">2</span> (воздействие, концентрация)</p><p><strong>Эффект:</strong> Вы бросаете <em>вечное извержение</em> с эффектом Застывшей лавы Массива Мхар. После 2d4 часов, <em>вечное извержение</em> восстанавливается в носимом вами контейнере, обычно в том, в котором вы хранили его последний раз.</p><p><em>Вечное извержение Массива Мхар</em> наносит 11d6 fire урона с простым спасброском Рефлекса.</p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p>Напоминающее <em>застывшую лаву</em>, <em>вечное извержение</em> создано с помощью того же типа магии времени, но построено таким образом, чтобы зацикливаться во времени, реформируя себя после использования. Чтобы определить разницу между ними, нужно внимательно присмотреться и увидеть слабый, повторяющийся узор из красных рун.</p><hr /><p><strong>Активация—Лавовая бомба:</strong><span class="action-glyph">2</span> (воздействие, концентрация)</p><p><strong>Эффект:</strong> Вы бросаете <em>вечное извержение</em> с эффектом Застывшей лавы Бледной горы. После 2d4 часов, <em>вечное извержение</em> восстанавливается в носимом вами контейнере, обычно в том, в котором вы хранили его последний раз.</p><p><em>Вечное извержение Бледной горы</em> наносит 9d6 fire урона с простым спасброском Рефлекса.</p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Слабый туман исходит от вашей кожи, давая вам в течение указанного времени состояние Скрытый на 3 раунда.</p><p>Как обычно, будучи скрытым когда ваша позиция всё ещё очевидна, вы не можете использовать его, чтобы Спрятаться или Красться.</p>`
    },
...

    {
        ...
        traits: ["алхимический", "расходуемый", "эликсир", "polymorph"],
        category: "эликсир",
        rarity: "common",
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Это солоноватое варево изменяет кожу на ваших руках и ногах. Промежутки между пальцами рук и ног становятся перепончатыми, что даёт вам Скорость плавания 20 футов на 24 часа, и вы можете дышать под водой.</p><p></p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Это солоноватое варево изменяет кожу на ваших руках и ногах. Промежутки между пальцами рук и ног становятся перепончатыми, что даёт вам Скорость плавания 20 футов на 1 час, и вы можете дышать под водой.</p><p></p>`
    },

    {
        ...
        weight: 0,
        usage: "worngarment",
        description: `<p>Этот свободная мантия имеет широкие, обширные рукава, каждый из которых содержит межпространственный карман. Каждое их этих пространств функционирует как @UUID[Compendium.pf2e.equipment-srd.Item.jaEEvuQ32GjAa8jy], которое может вмещать вплоть до 20 масс предметов (всего 40 масс), однако ни один из отдельных предметов не может быть более 1 массы; рукава становятся немного тяжелее по мере достижения максимальной вместимости. Вы можете добавить предмет или вытащить его из рукава одной свободной рукой, как действие Взаимодействовать.</p><p>Если рукав полностью пустой, вы можете положить своего фамильяра в этот межпространственный карман. Он может там комфортно жить вплоть до 4 часов, после чего начнёт задыхаться. Находясь в рукаве, на него не воздействуют эффекты и он не может быть целью любых эффектов, но вы не получаете преимущества от способностей хозяина. Фамильяр может выбраться из рукава по собственной воле с помощью одного действия, которое имеет признаки воздействие и движение. Вы не можете поместить любое другое существо в свои рукава, либо поместить своего фамильяра, если он больше чем крошечного размера. Если ваш фамильяр в рукаве, то вы не можете поместить никакие предметы в рукав.</p>`
    },

    {
        ...
        description: `<p>До активации, этот предмет выглядит как пепельный стержень, покрытый сталью с обоих концов.</p><hr /><p><strong>Активация—Нажать:</strong><span class="action-glyph">2</span> (воздействие, концентрация)</p><p><strong>Эффект:</strong> Вы представляете конкретный простой инструмент и инструментарий превращается в него (обычно вы можете выбрать из инструментов, перечисленных в главе 6, <a href=https://clck.ru/e7ARC>Инструмент (Tool)</a>). Это превращает деревянную часть в любое древко или рукоять, а металлические навершия в лопаты, головки молотков и т.п, что позволяет использовать самые простые инструменты, но не более сложные. Вы можете вернуть предмет в его форму жезла с помощью действия Взаимодействовать.</p>`
    },
...

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Эта настойка позволяет вам точно заострить внимание на своих врагов. На следующие 5 минут, ваши Удары алхимическими бомбами снижают бонус обстоятельства к КБ, получаемый врагами от укрытия на 1.</p><p></p>`
    },
...

    {
        ...
        weight: 0.1,
        usage: "wornmask",
        description: `<p>Эта ужасающая маска создана в облике злобного демона и даёт бонус предмета +2 к проверкам Запугивания.</p><hr /><p><strong>Активация—Злобная ухмылка:</strong><span class="action-glyph">2</span> (воздействие)</p><p><strong>Частота:</strong> Раз в день</p><p><strong>Эффект:</strong> Маска сотворяет @UUID[Compendium.pf2e.spells-srd.Item.4koZzrnMXhhosn0D] 3-го ранга с КС 29.</p>`
    },
...

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p>Напоминающее <em>застывшую лаву</em>, <em>вечное извержение</em> создано с помощью того же типа магии времени, но построено таким образом, чтобы зацикливаться во времени, реформируя себя после использования. Чтобы определить разницу между ними, нужно внимательно присмотреться и увидеть слабый, повторяющийся узор из красных рун.</p><hr /><p><strong>Активация—Лавовая бомба:</strong><span class="action-glyph">2</span> (воздействие, концентрация)</p><p><strong>Эффект:</strong> Вы бросаете <em>вечное извержение</em> с эффектом Застывшей лавы Бэрроусиджа. После 2d4 часов, <em>вечное извержение</em> восстанавливается в носимом вами контейнере, обычно в том, в котором вы хранили его последний раз.</p><p><em>Вечное извержение Бэрроусиджа</em> наносит 19d6 fire урона с простым спасброском Рефлекса.</p>`
    },
...

    {
        ...
        weight: 1,
        usage: "held-in-two-hands",
        description: `<p>Этот набор лекаря содержит, казалось бы, бесконечный запас бинтов, трав и предметов для исцеления безупречного качества, давая вам бонус предмета +3 к проверкам Медицины.</p><p>Если вы используете <em>чудесные лекарства</em> когда Лечите яд или Лечите болезнь, перед тем как совершить проверку, лекарства пытаются Противодействовать исцеляемых вами яда или болезни с рангом противодействия 8 и модификатором +30. Это эффект исцеления.</p><p>Эти лекарства нельзя повторно использовать для исцеления того же недуга этого пациента.</p>`
    },
...

    {
        ...
        weight: 0,
        usage: "affixed-to-weapon",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (концентрация)</p><hr /><p>Этот талисман представляет собой магически обработанный труп крошечной летучей мыши, обернутый папирусом. При активации, оружие, к которому он прикреплён, обнаруживает вибрации вокруг вас и направляет ваше восприятие. На 1 минуту вам не нужно проходить чистую проверку, чтобы целиться в Скрытых существ. Вы не Застигнуты врасплох для Спрятанных от вас существам (если только не застигнуты врасплох для них по другой причине кроме состояния спрятан), и вам достаточно пройти Чистую проверку, чтобы нацелиться на спрятанное существо. Соседние необнаруженные существа с уровнем меньше вашего вместо этого только спрятаны для вас.</p><p>Если у вас есть способность <em>"Бой вслепую"</em>, то вы получаете неточное чувство эхолокации с дистанцией 30 футов на 1 минуту. Существа, которые были бы для вас Необнаружены из-за того, что вы не можете их видеть, вместо этого Спрятаны.</p><p></p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Выпивание этого густого укрепляющего зелья дает сопротивление 15 к одному типу урона на 1 час. Каждое <em>зелье сопротивления</em> создано для защиты от звука, кислоты, огня, холода или электричества (и называется, соответственно, <em>малое зелье сопротивления огню</em> и т.д.).</p>`
    },

    {
        ...
        weight: 0.1,
        usage: "held-in-one-hand",
        description: `<p><strong>Активация:</strong><span class="action-glyph">1</span> (воздействие)</p><hr /><p>Выпивание этого густого укрепляющего зелья дает сопротивление 10 к одному типу урона на 1 час. Каждое <em>зелье сопротивления</em> создано для защиты от звука, кислоты, огня, холода или электричества (и называется, соответственно, <em>малое зелье сопротивления огню</em> и т.д.).</p>`
    },
...

    {
        ...
        traits: ["сакральный", "инвестируемый", "light"],
        category: "misc",
        rarity: "common",
        weight: 0,
        usage: "worn",
        description: `<p>Если вы поклоняетесь какому-либо божеству, этот золотой амулет превращается в религиозный символ вашего божества, когда вы инвестируете его. Вы получаете бонус предмета +3 к Религии. Символ излучает тусклый свет в 20-футовой эманации.</p><hr /><p><strong>Активация—Духовный свет:</strong><span class="action-glyph">2</span> (концентрация, откровение, свет)</p><p><strong>Частота:</strong> Раз в день</p><p><strong>Эффект:</strong> Излучаемый символом свет становится ярким на 10 минут и светит сквозь тела, выявляя признаки духов внутри. Существа в свете получают штраф состояния −3 к проверкам Обмана и Скрытности, и, пока он активен, ваши противники получают в этом свете слабость 10 к духовному урону.</p><p>Вы можете "Развеять" эту активацию.</p><p></p><hr /><p><strong>Требования для создания:</strong> Вы должны быть святым или нечестивым.</p>`
    },

    {
        ...
        weight: 0,
        usage: "etched-onto-armor",
        description: `<p>Это свойство делает доспех скользким, как будто он покрыт тонкой пленкой масла. Вы получаете бонус предмета +3 к проверкам Акробатики, чтобы Вырваться и Протиснуться.</p>`
    },

    {
        ...
        weight: 1,
        usage: "held-in-one-hand",
        description: `<p>Это медное кадило, которое болтается на длинной цепочке. Большинство <em>курильниц откровения</em> украшены кружащимся Эмпирейскими текстами, хотя некоторые из них сделаны из железа и содержат Дьявольские или Хтонические тексты.</p><hr /><p><strong>Активация—Сжечь благовония:</strong><span class="action-glyph">2</span> (воздействие)</p><p><strong>Стоимость:</strong> благовония стоимостью хотя бы 5 зм</p><p><strong>Эффект:</strong> Вы зажигаете благовония внутри кадила и они горят 1 час. В течение этого времени, пока вы держите курильницу, вы получаете бонус предмета +1 к проверкам Религии и любые критические провалы при Расшифровке текста религиозной природы становятся просто провалами.</p><p></p>`
    },

    {
        ...gear(source.GMCore.key, 1109, 'Волшебная палочка продолжения [1-го ранга] / волшебная палочка of Continuation (1st-Rank Spell)', '160G', ''),
        ...price(0, 160, 0, 0),
        nameGear: "Волшебная палочка продолжения [1-го ранга] / волшебная палочка of Continuation (1st-Rank Spell)",
        traits: ["магический", "волшебная палочка"],
        category: "misc",
        rarity: "common",
        weight: 0.1,
        usage: "held-in-one-hand",
    ...
    {
        ...gear(source.GMCore.key, 1110, 'Волшебная палочка продолжения [2-го ранга] / волшебная палочка of Continuation (2nd-Rank Spell)', '360G', ''),
        ...price(0, 360, 0, 0),
        nameGear: "Волшебная палочка продолжения [2-го ранга] / волшебная палочка of Continuation (2nd-Rank Spell)",
        traits: ["магический", "волшебная палочка"],
        category: "misc",
        rarity: "common",
        weight: 0.1,
    ...
    {
        ...gear(source.GMCore.key, 1111, 'Волшебная палочка продолжения [3-го ранга] / волшебная палочка of Continuation (3rd-Rank Spell)', '700G', ''),
        ...price(0, 700, 0, 0),
        nameGear: "Волшебная палочка продолжения [3-го ранга] / волшебная палочка of Continuation (3rd-Rank Spell)",
        traits: ["магический", "волшебная палочка"],
        category: "misc",
        rarity: "common",
        weight: 0.1,
    ...
    {
        ...gear(source.GMCore.key, 1112, 'Волшебная палочка продолжения [4-го ранга] / волшебная палочка of Continuation (4th-Rank Spell)', '1500G', ''),
        ...price(0, 1500, 0, 0),
        nameGear: "Волшебная палочка продолжения [4-го ранга] / волшебная палочка of Continuation (4th-Rank Spell)",
        traits: ["магический", "волшебная палочка"],
        category: "misc",
        rarity: "common",
        weight: 0.1,
    ...
    {
        ...gear(source.GMCore.key, 1113, 'Волшебная палочка продолжения [5-го ранга] / волшебная палочка of Continuation (5th-Rank Spell)', '3000G', ''),
        ...price(0, 3000, 0, 0),
        nameGear: "Волшебная палочка продолжения [5-го ранга] / волшебная палочка of Continuation (5th-Rank Spell)",
        traits: ["магический", "волшебная палочка"],
        category: "misc",
        rarity: "common",
        weight: 0.1,
    ...
    {
        ...gear(source.GMCore.key, 1114, 'Волшебная палочка продолжения [6-го ранга] / волшебная палочка of Continuation (6th-Rank Spell)', '6500G', ''),
        ...price(0, 6500, 0, 0),
        nameGear: "Волшебная палочка продолжения [6-го ранга] / волшебная палочка of Continuation (6th-Rank Spell)",
        traits: ["магический", "волшебная палочка"],
        category: "misc",
        rarity: "common",
        weight: 0.1,
    ...
    {
        ...gear(source.GMCore.key, 1115, 'Волшебная палочка продолжения [7-го ранга] / волшебная палочка of Continuation (7th-Rank Spell)', '15000G', ''),
        ...price(0, 15000, 0, 0),
        nameGear: "Волшебная палочка продолжения [7-го ранга] / волшебная палочка of Continuation (7th-Rank Spell)",
        traits: ["магический", "волшебная палочка"],
        category: "misc",
        rarity: "common",
        weight: 0.1,
    ...
    {
        ...gear(source.GMCore.key, 1116, 'Волшебная палочка продолжения [8-го ранга] / волшебная палочка of Continuation (8th-Rank Spell)', '40000G', ''),
        ...price(0, 40000, 0, 0),
        nameGear: "Волшебная палочка продолжения [8-го ранга] / волшебная палочка of Continuation (8th-Rank Spell)",
        traits: ["магический", "волшебная палочка"],
        category: "misc",
        rarity: "common",
        weight: 0.1,
...

    {
        ...
        weight: 0,
        usage: "worn",
        description: `<p>На протяжении тысячелетий эти загадочные, искусно ограненные драгоценные камни хранили мистики и фанатики, надеясь разгадать их секреты. Несмотря на огромное количество форм и функций, эти камни якобы являются фрагментами кристаллических инструментов, использовавшихся потусторонними сущностями для создания Вселенной в первородные времена.</p><p>Когда вы инвестируете один из этих кристаллов точной формы, камень вращается вокруг вашей головы, а не носится на теле. Вы можете спрятать <em>камень эонов</em> действием Взаимодействовать, а кружащийся вокруг камень можно выхватить из воздуха успешным действием Разоружение против вас. Убранный или снятый камень остается инвестированным, но его эффекты подавляются, пока вы не вернете его на орбиту вокруг вашей головы.</p><p>Существуют различные типы <em>камней эонов</em>, каждый из которых имеет свой внешний вид и магический эффект. Каждый <em>камень эона</em> также приобретает силу резонанса, если поместить его в специальный магический предмет, называемый @UUID[Compendium.pf2e.equipment-srd.Item.gbwr57aT9ou8yKWT].</p><hr /><p>Когда вы умираете в состоянии @UUID[Compendium.pf2e.conditionitems.Item.yZRUzMqrMmfLu0V1], этот гладкий розовый камень автоматически активируется и снизит значение вашего состояния при смерти на 1 меньше, при котором вы бы обычно не умерли (обычно при смерти 3). Потом этот камень навсегда превращается в @UUID[Compendium.pf2e.equipment-srd.Item.CVTbxCY85nLoHYuw]. Вы можете получить преимущество от этой возможности только раз в день, даже если имеете несколько таких камней.</p><p>Сила резонанса позволяет вам 1 раз в день сотворять @UUID[Compendium.pf2e.spells-srd.Item.rfZpqmj0AIIdkVIs], как врождённое сакральное заклинание.</p>`
    },

    {
        ...gear(source.GMCore.key, 1118, 'Браслеты силы [Превосходные] / Bands of сила (Major)', '70000G', ''),
        ...price(0, 70000, 0, 0),
        nameGear: "Браслеты силы [Превосходные] / Bands of сила (Major)",
        traits: ["сила", "инвестируемый", "магический"],
        category: "misc",
        rarity: "common",
        weight: 0.1,
        usage: "wornbracers",
        description: `<p>Украшенные прозрачными драгоценными камнями, эти толстые металлические браслеты распространяют по вашему телу несгибаемый слой силы. Сила дает вам бонус предмета +3 к КБ и спасброскам, и имеют максимальный модификатор Ловкости +5. Вы можете присоединять к ним талисманы, как будто они являются лёгким доспехом.</p><hr /><p><strong>Активация—Возвратная сила:</strong><span class="action-glyph">R</span> (воздействие, сила)</p><p><strong>Триггер:</strong> Существо критически промахивается по вам "Ударом" ближнего боя</p><p><strong>Эффект:</strong> Вы Толкаете существо, используя модификатор Атлетики наручей +33.</p>`
    },

    {
        ...
        weight: 0.1,
        usage: "worncloak",
        description: `<p>Когда вы накидываете капюшон этого невзрачного серого плаща (действием Взаимодействовать), вы становитесь невзрачным и неинтересным, получая бонус предмета +2 к проверкам Скрытности и проверкам Обмана, чтобы Перевоплотиться в непримечательного персонажа второго плана, такого как слуга, но также получая штраф предмета −1 к проверкам Дипломатии и Запугивания.</p><hr /><p><strong>Активация—Скрыть личность:</strong><span class="action-glyph">2</span> (воздействие, концентрация)</p><p><strong>Частота:</strong> Раз в день</p><p><strong>Эффект:</strong> Вы накидываете капюшон плаща и получаете преимущества @UUID[Compendium.pf2e.spells-srd.Item.EoKBlgf6Smt8opaU] 5-го ранга на 8 часов или до тех пор, пока не снимете капюшон, в зависимости от того, что произойдёт раньше.</p>`
    },

    {
        ...
        weight: 0.1,
        usage: "wornshoes",
        description: `<p>Эти ярко окрашенные ботинки на мягкой подошве мотивируют вас выполнять рискованные трюки и придают вам ловкость, необходимую для успеха. Ботинки дают вам бонус предмета +3 к проверкам Акробатики и бонус обстоятельства +2 к проверкам Проскочить пространство противника.</p><p>Ботинки могут цепляться за твердые поверхности и помогать избежать падения, позволяя вам использовать реакцию Схватиться за уступ, даже если ваши руки заняты. Вы считаете падения на 10 футов короче, или если у вас есть способность Кошачье падение, то для определения преимуществ этой способности, считайте свой уровень мастерства Акробатики на одну степень выше. Если у вас есть <em>"Кошачье падение"</em> и вы уже легенда Акробатики, то можете выбирать скорость своего падения, от 60 футов за раунд до обычной скорости падения.</p><hr /><p><strong>Активация—Импульс смельчака:</strong><span class="action-glyph">2</span> (концентрация)</p><p><strong>Частота:</strong> Раз в день</p><p><strong>Эффект:</strong> Ботинки сотворяют на вас @UUID[Compendium.pf2e.spells-srd.Item.aqRYNoSvxsVfqglH].</p>`
    }
