...
const traitRepository = [
    ...
    },
    {
        ...
        key: "Применяемый к щиту",
        nameEng: "Applied to shield",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый на доспех",
        nameEng: "Affixed to Armor",
    ...
    },
    {
        ...
        key: "Шаг дистанции 280 футов",
        nameEng: "Range Increment 280 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый к магическому посоху",
        nameEng: "Affixed to a Magical Staff",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Выграв. на оружии ближнего боя с признаком `монах`",
        nameEng: "Etched onto a melee weapon with the monk trait",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Дистанция 5 футов",
        nameEng: "Range 5 feet",
    ...
    },
    {
        ...
        key: "Выграв. на оружии которое не свято",
        nameEng: "Etched on Weapon that isn't Holy",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Шаг дистанции 160 футов",
        nameEng: "Range Increment 160 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Размашистый",
        nameEng: "Flourish",
        desc: "Действия с признаком `размашистый` — особые приёмы, требующие от вас слишком больших усилий, чтобы выполнять их часто. Вы можете использовать только одно действие с признаком `размашистый` за раунд."
    },
    {
        source: {
            ...source.playerCore,
    ...
    },
    {
        ...
        key: "Дистанция 280 футов",
        nameEng: "Range 280 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Выграв. на оружии без аксиоматической руной",
        nameEng: "Etched on Weapon w/o Axiomatic Rune",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Дистанция 290 футов",
        nameEng: "Range 290 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Шаг дистанции 210 футов",
        nameEng: "Range Increment 210 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Багбер",
        nameEng: "Bugbear",
        desc: "Существо с этим признаком — мохнатый, скрытный гоблиноид. Багбиры обычно обладают ночным зрением."
    },
    {
        source: {
            ...source.playerCore,
    ...
    },
    {
        ...
        key: "Дистанция 200 футов",
        nameEng: "Range 200 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Шаг дистанции 310 футов",
        nameEng: "Range Increment 310 feet",
        desc: ""
    },
    {
        source: {
        ...
        key: "Шаг дистанции 60 футов",
        nameEng: "Range Increment 60 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Применяемый к доспеху или одежде защиты без доспехов",
        nameEng: "Applied to armor or unarmored defense clothing",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый на металлическое оружие",
        nameEng: "Affixed to a Metal Weapon",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Применяемый к обуви",
        nameEng: "Applied to Footwear",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Выграв. на рубящем/колющем оружии",
        nameEng: "Etched on Piercing/Slashing Weapon",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Удержание 2 руками",
        nameEng: "Held in 2 hands",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый на доспех или походную одежду",
        nameEng: "Affixed to Armor or Travelers Clothing",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Шаг дистанции 75 футов",
        nameEng: "Range Increment 75 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый к предмету защиты без доспеха",
        nameEng: "Affixed to Unarmored Defense Item",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Укрепиться против дальнобойных атак",
    ...
    },
    {
        ...
        key: "Ядовитое",
        nameEng: "Venomous",
        desc: "These weapons inject poison into every hit. When you hit a creature with this weapon, it deals an additional 1 persistent poison damage. This increases to 2 persistent poison damage if the weapon has a greater striking rune."
    },
    {
        source: {
            ...source.playerCore,
    ...
    },
    {
        ...
        key: "Дистанция 500 футов",
        nameEng: "Range 500 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Дистанция 20 футов",
        nameEng: "Range 20 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Дистанция 30 футов",
        nameEng: "Range 30 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый к метательному оружию",
        nameEng: "Affixed to a Thrown Weapon",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Дистанция 25 футов",
        nameEng: "Range 25 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Шаг дистанции 110 футов",
        nameEng: "Range Increment 110 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Дистанция 130 футов",
        nameEng: "Range 130 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Шаг дистанции 30 футов",
        nameEng: "Range Increment 30 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Шаг дистанции 270 футов",
        nameEng: "Range Increment 270 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Дистанция 120 футов",
        nameEng: "Range 120 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый на инструмент",
        nameEng: "Affixed to Instrument",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый к метательному оружию",
        nameEng: "Attached to a Thrown Weapon",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Выграв. на метательном оружии",
        nameEng: "Etched on Thrown Weapon",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        desc: "Способность с этим признаком изменяет конструкцию вашей инновации. Если у вас есть классовая особенность \"Перенастройка\", то вы можете легче переобучиться такой способности."
    },
    {
        source: {
            ...source.playerCore,
    ...
    },
    {
        ...
        key: "Дистанция 40 футов",
        nameEng: "Range 40 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый к объекту, структуре или существу",
        nameEng: "Affixed to Structure, Object, or Creature",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Дистанция 270 футов",
        nameEng: "Range 270 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Применяемый к не-инъекционному оружию ближнего боя, наносящему колющий урон",
        nameEng: "Applied to a non-injection melee weapon that deals piercing damage",
        desc: ""
    },
    {
        source: {
        ...
        key: "Прикрепляемый к огнестрельному оружию",
        nameEng: "Affixed to Firearm",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Татуирован на теле",
        nameEng: "Tattooed on the Body",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Шаг дистанции 15 футов",
        nameEng: "Range Increment 15 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Применяемый к дуэльной накидке или щиту",
        nameEng: "Applied to dueling cape or shield",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Дистанция 240 футов",
        nameEng: "Range 240 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Шаг дистанции 25 футов",
        nameEng: "Range Increment 25 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Дистанция 210 футов",
        nameEng: "Range 210 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Шаг дистанции 20 футов",
        nameEng: "Range Increment 20 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Дистанция 160 футов",
        nameEng: "Range 160 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Шаг дистанции 290 футов",
        nameEng: "Range Increment 290 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Шаг дистанции 300 футов",
        nameEng: "Range Increment 300 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый на доспех или к оружию",
        nameEng: "Affixed to Armor or a Weapon",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Дистанция 100 футов",
        nameEng: "Range 100 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Шаг дистанции 320 футов",
        nameEng: "Range Increment 320 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый к объекту или структуре",
        nameEng: "Affixed to an Object or Structure",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Выграв. на тяжелом доспехе",
        nameEng: "Etched onto Heavy Armor",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Дистанция 170 футов",
        nameEng: "Range 170 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Шаг дистанции 40 футов",
        nameEng: "Range Increment 40 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый к огнестрельному оружию и арбалетам",
        nameEng: "Affixed to Crossbow or Firearm",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Шаг дистанции 170 футов",
        nameEng: "Range Increment 170 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый на щит",
        nameEng: "Affixed to a Shield",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый на головные уборы",
        nameEng: "Affixed to Headgear",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Дистанция 90 футов",
        nameEng: "Range 90 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Дистанция 80 футов",
        nameEng: "Range 80 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Отражение заклинаний",
        nameEng: "Spell Deflection",
        desc: "Существо с этим признаком обладает универсальным наследием отражения. Отражения это существа скопированные с других живых индивидов, будь то клонированием, планарным дублированием или другим способом. Умения с этим признаком могут быть выбраны или использованы только отражениями."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Выграв. на легком доспехе",
        nameEng: "Etched onto Light Armor",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Дистанция 50 футов",
        nameEng: "Range 50 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Дистанция 10 футов",
        nameEng: "Range 10 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Выграв. на оружии ближнего боя",
        nameEng: "Etched on Melee Weapon",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Шаг дистанции 5 футов",
        nameEng: "Range Increment 5 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый к земле в четырех местах по кругу с радиусом 10 футов",
        nameEng: "Affixed to the Ground in Four Spaces Along a Circle with a 10-foot Radius",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Удержание 1 рукой или без рук",
        nameEng: "Held in 1 hand or free-standing",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый на оружие ближнего боя",
        nameEng: "Affixed to a Melee Weapon",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Применяемый к поясу, накидке, плащу или шарфу",
        nameEng: "Applied to belt, cape, cloak, or scarf",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Применяемый к оружию",
        nameEng: "Applied to a weapon",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Выграв. на рубящем/колющем оружии ближнего боя",
        nameEng: "Etched on Piercing/Slashing Melee Weapon",
        desc: ""
    },
    {
        source: {
        ...
        desc: "Это оружие имеет 2 ствола, каждый из которых заряжается отдельно. Вы можете выстрелить из обоих стволов двуствольного оружия за один Выстрел, чтобы увеличить размер кости урона оружия на один шаг. Если оружие имеет признак фатальное, то это также увеличивает на один шаг и размер кости фатального урона."
    },
    {
        source: {
            ...source.playerCore,
    ...
    },
    {
        ...
        key: "Дистанция 260 футов",
        nameEng: "Range 260 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Применяемый к любому видимому предмету одежды",
        nameEng: "Applied to any visible article of clothing",
        desc: ""
    },
    {
        source: {
        ...
        key: "Tearing",
        nameEng: "Tearing",
        desc: "This weapon is edged with curved teeth that leave bleeding wounds. When you hit a creature with this weapon, it deals an additional 1 persistent bleed damage. This increases to 2 persistent bleed damage if the weapon has a greater striking rune."
    },
    {
        source: {
            ...source.playerCore,
    ...
    },
    {
        ...
        key: "Дистанция 140 футов",
        nameEng: "Range 140 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый к арбалету или огнестрельному оружию (спусковой механизм)",
        nameEng: "Attached to Crossbow or Firearm (Firing Mechanism)",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
        ...
        key: "Выграв. на среднем или тяжелом металл. доспехе",
        nameEng: "Etched onto Medium or Heavy Metal Armor",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Шаг дистанции 220 футов",
        nameEng: "Range Increment 220 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый к земле в четырех местах по кругу с радиусом 20 футов",
        nameEng: "Affixed to the Ground in Four Spaces Along a Circle with a 20-foot Radius",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Дистанция 320 футов",
        nameEng: "Range 320 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Шаг дистанции 230 футов",
        nameEng: "Range Increment 230 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Выграв. на оружии",
        nameEng: "Etched onto a Weapon",
        desc: ""
    },
    {
        source: {
        ...
        key: "Шаг дистанции 70 футов",
        nameEng: "Range Increment 70 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Дистанция 15 футов",
        nameEng: "Range 15 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Шаг дистанции 50 футов",
        nameEng: "Range Increment 50 feet",
        desc: ""
    },
    {
        source: {
        ...
        key: "Прикрепляемый к огнестрельному оружию с Перезарядкой 1",
        nameEng: "Affixed to a Firearm With a Reload of 1",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Применяемый к корзине, сумке или другому контейнеру",
        nameEng: "Applied to a Basket, Bag, or Other Container",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый к земле",
        nameEng: "Affixed to the Ground",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
        ...
        key: "Шаг дистанции 100 футов",
        nameEng: "Range Increment 100 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Носить или держать в одной руке",
        nameEng: "Worn or Held in One Hand",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Удержание 1 рукой",
        nameEng: "Held in 1 hand",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Каждая руна наносится на отдельный предмет имеющий карманы",
        nameEng: "Each rune applied to a separate item that has pockets",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Шаг дистанции 90 футов",
        nameEng: "Range Increment 90 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый к дистанционному оружию",
        nameEng: "Affixed to a Ranged Weapon",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый к сбруе",
        nameEng: "Affixed to Harness",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
        ...
        key: "Brace",
        nameEng: "Brace",
        desc: "A brace weapon is effective at damaging moving opponents. When you Ready to Strike an opponent that moves within your reach, until the start of your next turn Strikes with the brace weapon deal an additional 2 precision damage for each weapon damage die it has."
    },
    {
        source: {
            ...source.playerCore,
    ...
    },
    {
        ...
        key: "Носимый под легкими доспехами или одеждой",
        nameEng: "Worn Under Light Armor or Clothes",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Шаг дистанции 200 футов",
        nameEng: "Range Increment 200 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый на несущую стену или колонну",
        nameEng: "Affixed to a Load-Bearing Wall or Pillar",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый к огнестрельному оружию с признаком `Отдача`",
        nameEng: "Affixed to a Firearm With the Kickback Trait",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Выграв. на доспехе",
        nameEng: "Etched onto Armor",
        desc: ""
    },
    {
        source: {
        ...
        key: "Дистанция 250 футов",
        nameEng: "Range 250 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
        ...
        key: "Прикрепляемый к огнестрельному оружию (прицел)",
        nameEng: "Attached To Firearm (Scope)",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый к оружию",
        nameEng: "Affixed to a Weapon",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый на инновацию",
        nameEng: "Affixed to an Innovation",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый на металлический средний или тяжелый доспех",
        nameEng: "Affixed to Medium or Heavy Metal Armor",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Удержание 1 или 2 руками",
        nameEng: "Held in 1 or 2 hands",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Дистанция 60 футов",
        nameEng: "Range 60 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
        ...
        key: "Демон",
        nameEng: "Demon",
        desc: "Род бесов, демонов родом или происходящих из Внешних Разломов. Большинство из них неисправимо нечестивые и обладают ночным зрением и слабостью к холодному железу и святому."
    },
    {
        source: {
            ...source.playerCore,
    ...
    },
    {
        ...
        key: "Выграв. на оружии без анархической руной",
        nameEng: "Etched on Weapon w/o Anarchic Rune",
        desc: ""
    },
    {
        source: {
        ...
        key: "Отражающий Физический дальнобойный",
    ...
    },
    {
        ...
        key: "Шаг дистанции 10 футов",
        nameEng: "Range Increment 10 feet",
        desc: ""
    },
    {
        source: {
        ...
        key: "Дистанция 180 футов",
        nameEng: "Range 180 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Шаг дистанции 130 футов",
        nameEng: "Range Increment 130 feet",
        desc: ""
    },
    {
        source: {
        ...
        key: "Применяемый к ботинкам, накидке, плащу или зонту",
        nameEng: "Applied to boots, cape, cloak, or umbrella",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Выграв. на рубящем оружии ближнего боя",
        nameEng: "Etched on Slashing Melee Weapon",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Дистанция 220 футов",
        nameEng: "Range 220 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Выграв. на легком или среднем неметал. доспехе",
        nameEng: "Etched on L/M Nonmetal Armor",
        desc: ""
    },
    {
        source: {
        ...
        key: "Дистанция 230 футов",
        nameEng: "Range 230 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Дистанция 150 футов",
        nameEng: "Range 150 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
        ...
        key: "Применяемый к любому предмету легкой или незначительной Массы",
        nameEng: "Applied to any item of light or negligible Bulk",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Выграв. на клановом кинжале",
        nameEng: "Etched on Clan Dagger",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Processed",
        nameEng: "Processed",
        desc: "An alchemical consumable with the processed trait can be created with Quick Alchemy but is too complex to create in a single action."
    },
    {
        source: {
            ...source.playerCore,
    ...
    },
    {
        ...
        key: "Шаг дистанции 240 футов",
        nameEng: "Range Increment 240 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый к носу корабля",
        nameEng: "Attached to a Ship's Bow",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Носимый и прикрепленный к двум оружиям",
        nameEng: "Worn and Attached to Two Weapons",
        desc: ""
    },
    {
        source: {
        ...
        key: "Шаг дистанции 80 футов",
        nameEng: "Range Increment 80 feet",
        desc: ""
    },
    {
        source: {
        ...
        key: "Шаг дистанции 180 футов",
        nameEng: "Range Increment 180 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый на щит или оружие",
        nameEng: "Affixed to a Shield or Weapon",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Выграв. на оружии которое не нечестиво",
        nameEng: "Etched on Weapon that isn't Unholy",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Шаг дистанции 120 футов",
        nameEng: "Range Increment 120 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Шаг дистанции 35 футов",
        nameEng: "Range Increment 35 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемое к оружию ближнего боя",
        nameEng: "Attached to a Melee Weapon",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Применяемый к транспортному средству передвигаемому ветром",
        nameEng: "Applied to a wind-powered vehicle",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Применяемый к среднему или тяжелому доспех",
        nameEng: "Applied to Medium or Heavy Armor",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Дистанция 70 футов",
        nameEng: "Range 70 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Дистанция 300 футов",
        nameEng: "Range 300 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
        ...
        key: "Прикрепляемый к арбалету или огнестрельному оружию (прицел)",
        nameEng: "Attached to Crossbow or Firearm (Scope)",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый к двуручному огнестрельному оружию и арбалетам",
        nameEng: "Affixed to a Two-Handed Firearm or Crossbow",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Применяемый к доспеху",
        nameEng: "Applied to armor",
        desc: ""
    },
    {
        source: {
        ...
        key: "Дистанция 190 футов",
        nameEng: "Range 190 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Шаг дистанции 140 футов",
        nameEng: "Range Increment 140 feet",
        desc: ""
    },
    {
        source: {
        ...
        key: "Прикрепляемый к огнестрельному оружию (спусковой механизм)",
        nameEng: "Attached To Firearm (Firing Mechanism)",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Применяемый к баклеру или щиту",
        nameEng: "Applied to a buckler or a shield",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Прикрепляемый на средний или тяжелый доспех",
        nameEng: "Affixed to Medium or Heavy Armor",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Дистанция 110 футов",
        nameEng: "Range 110 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Выграв. на дробящем оружии",
        nameEng: "Etched on Bludgeoning Weapon",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Выграв. на среднем или тяжелом доспехе",
        nameEng: "Etched onto Medium or Heavy Armor",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Шаг дистанции 260 футов",
        nameEng: "Range Increment 260 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Шаг дистанции 250 футов",
        nameEng: "Range Increment 250 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Дистанция 310 футов",
        nameEng: "Range 310 feet",
        desc: "Эти атаки имеют или ограниченную дистанцию или указанный шаг дистанции, который следует правилам обычных шагов дистанции."
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Шаг дистанции 150 футов",
        nameEng: "Range Increment 150 feet",
        desc: ""
    },
    {
        source: {
    ...
    },
    {
        ...
        key: "Выграв. на металлическом доспехе",
        nameEng: "Etched onto Metal Armor",
        desc: ""
    },
    {
        source: {
        ...
        key: "Прикрепляемый к существу",
        nameEng: "Affixed to a Creature",
        desc: "Для использования, прикрепляемое оружие должно быть объединено с другим снаряжением. Вы должны владеть или носить предмет, к которому прикреплено оружие, чтобы атаковать им. Признак указывает к какому виду предмета оружие должно быть прикреплено. Например, шипы для щита, прикрепляются к щиту, позволяя вам атаковать шипами вместо удара щитом, но только если вы владеете щитом. Прикрепленное оружие обычно привинчивается на основной предмет или встраивается в него, и как правило, предмет может иметь только одно прикрепляемое к нему оружие. Прикрепляемое оружие может быть установлено на предмет за 10 минут работы и успешной проверки Ремесла с @Check[crafting|dc:10]{КС 10}; при необходимости это включает время, нужное, чтобы убрать оружие с предыдущего установленного оружия. Если предмет уничтожен, то обычно прикрепленное оружие можно подобрать."
    },
    {
        source: {
        ...
        key: "Шаг дистанции 190 футов",
        nameEng: "Range Increment 190 feet",
        desc: ""
    },
    {
        source: {
